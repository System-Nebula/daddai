...
from config import USE_GPU, EMBEDDING_BATCH_SIZE, CHUNK_SIZE, CHUNK_OVERLAP
...
def main():
    ...
    try:
        ...
        if args.action == 'upload':
            ...
            chunks = document_store.get_document_chunks(args.doc_id)
            response = {"chunks": chunks, "count": len(chunks), "doc_id": args.doc_id}
            print(json.dumps(response), file=sys.stdout)
            sys.stdout.flush()
