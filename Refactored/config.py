"""
Configuration file for the refactored RAG system.
...
NEO4J_MAX_CONNECTION_LIFETIME = int(os.getenv("NEO4J_MAX_CONNECTION_LIFETIME", "7200"))
NEO4J_MAX_CONNECTION_POOL_SIZE = int(os.getenv("NEO4J_MAX_CONNECTION_POOL_SIZE", "100"))
NEO4J_CONNECTION_ACQUISITION_TIMEOUT = float(os.getenv("NEO4J_CONNECTION_ACQUISITION_TIMEOUT", "60.0"))
...
CHUTES_TIMEOUT = int(os.getenv("CHUTES_TIMEOUT", "90"))
...
HYDE_USE_ORIGINAL_QUERY = os.getenv("HYDE_USE_ORIGINAL_QUERY", "true").lower() == "true"
...
# A2A Configuration
A2A_MESSAGE_TIMEOUT = int(os.getenv("A2A_MESSAGE_TIMEOUT", "30"))
A2A_MAX_RETRIES = int(os.getenv("A2A_MAX_RETRIES", "3"))
A2A_ENABLE_EVENTS = os.getenv("A2A_ENABLE_EVENTS", "true").lower() == "true"
